                ...
                <div className="relative z-10 flex flex-col items-center gap-4 w-full max-w-sm">
                    ...
                    <div className="text-center mb-2">
                        <div className="inline-flex items-center gap-2 mb-3">
                            <div className="w-9 h-9 rounded-full bg-[#7C3AED]/10 border border-[#7C3AED]/30 flex items-center justify-center shadow-[0_0_20px_rgba(124,58,237,0.15)]">
                        ...
                        <p className="text-gray-500 text-sm">Create your account to start monitoring</p>
                    </div>

                    {/* Clerk SignUp — Light theme */}
                    <SignUp
                        appearance={{
                            elements: {
                                rootBox: "w-full",
                                ...
                                formFieldInput: "!bg-gray-50 !border !border-gray-200 !text-gray-900 !rounded-xl focus:!border-[#7C3AED] focus:!ring-[#7C3AED]/20 placeholder:!text-gray-400",
                                formButtonPrimary: "!bg-gradient-to-r !from-[#7C3AED] !to-[#0070F3] hover:!from-[#6D28D9] hover:!to-[#0060df] !text-white !font-semibold !rounded-xl !transition-all !shadow-[0_4px_16px_rgba(124,58,237,0.25)]",
                                footerActionLink: "!text-[#7C3AED] hover:!text-[#6D28D9] !font-semibold",
